...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of GYAlertController.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Gyang/GYAlertController'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Gyang' => 'goyaya@yeah.net' }
  s.source           = { :git => 'https://github.com/Gyang/GYAlertController.git', :tag => s.version.to_s }
